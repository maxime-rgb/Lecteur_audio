...
<div class="jumbotron text-center" id="jumbo">
  <h1>WELCOME TO OUI</h1>
  <p>You can chat with a lot of people and it's free. <br>just sign up/login and go </p> 
</div>


<div class="card-deck" id="registerlog"> 
  <div class="card border-primary mb-3" style="max-width: 18rem;" id="register">
  ...
  <div class="card border-danger mb-3" style="max-width: 18rem;" id="login">
